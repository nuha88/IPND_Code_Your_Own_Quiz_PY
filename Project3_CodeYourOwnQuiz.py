...
def do_quiz(q_str, parts_of_speech, correct_answers):
    ...
    for word in q_str:
        ...
        while replacement != None:
            ...
            new_str = replaced + q_str[len(replaced): ]
            print " ".join(new_str)
    ...
    return text_format("You have just completed the following string:")+  text_format(replaced) +text_format("Thank you for completing the quiz :)")
